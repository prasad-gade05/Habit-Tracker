...
const PerformanceBreakdown: React.FC = () => {
  ...
  const overallAverage = useMemo(() => {
    ...
    const totalPercentage = habitPerformance.reduce(
      (sum, habit) => sum + habit.percentage,
      0
    );
          ...
          habitPerformance.map((habit) => (
            <div key={habit.id} className="space-y-2">
              ...
              <div className="w-full bg-secondary rounded-full h-2">
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: habit.labelColor
                      .replace("bg-", "")
                      .replace("-500", ""),
                  }}
                ></div>
              ...
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={`px-2 py-1 rounded text-xs text-white ${habit.labelColor}`}
                >
                  {habit.label}
                </span>
              </div>
